        ...
        " style={{zIndex:999}}>
          <div className="container-fluid ">
            ...
            <button
              ...
              style={{border:"none"}}
            >
              <FaSearch className='m-sm-3 m-2 position-absolute' style={{color:"#8064A2",right:"100px",top:"30%"}}/>
              <FaBell className='m-sm-3 m-2 position-absolute' style={{color:"#8064A2",right:"60px",top:"30%"}}/>
              <FaBars className='m-sm-3 m-2 position-absolute' style={{color:"#8064A2",right:"20px",top:"30%"}}/>
            </button>
            ...
            <form className="navbar-nav me-auto custom-input" role="search">
                ...
                <button className="btn custom-purple center" type="submit">
                  <FaSearch style={{backgroundColor:"#0000"}}/>
                </button>
              </form>
