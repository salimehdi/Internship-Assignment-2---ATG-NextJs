      ...
      >
        <div className="card-body">
          ...
          <Image
                ...
                alt="Description for TestimonialsIcon"
                className="me-3"
                layout="intrinsic"
              />
            Testimonials
          ...
          <div className="col-12 mt-4 mx-auto col-lg-4 d-flex justify-content-evenly align-items-center" style={{width:"300px"}}>
            ...
            >
              ...
              >
                <Image
                src={AudioPlayButton}
                alt="Description for AudioPlayButton"
              ...
              <span style={{ width: "60%",position:"relative" }}>
                ...
                <svg
                  ...
                  style={{ top: "-4px", backgroundColor:"#0000"}}
                  width="12"
                  height="12"
                  viewBox="0 0 12 12"
                  fill="none"
                ...
                <span style={{color:"#8064A2", position:"absolute",top:"-6px", right: "-6%" , fontSize:"11px", backgroundColor:"#0000"}}>0:00</span>
              </span >

              <span style={{ width: "8%",position:"relative", backgroundColor:"#0000" }}>
              <Image
                src={micIcon}
                alt="Description for micIcon"
                style={{ bottom:0 , left:0,position:"absolute", backgroundColor:"#0000" }}
                layout="intrinsic"
              />
              <Image
                src={Musician}
                alt="Description for Musician"
                style={{ height: "50px" , backgroundColor:"#0000"}}
                layout="intrinsic"
              />
              </span>
