...
function Footer() {
  ...
  return (
    <>
    <div className="row vw-100 d-flex justify-content-center " style={{ height: "auto", color:"black" }}>
    ...
    <div style={{backgroundColor:"#F7F5F9",color:"black",fontWeight:"500",height:"40px",display:"flex",justifyContent:"center",alignItems:"center"}}>
