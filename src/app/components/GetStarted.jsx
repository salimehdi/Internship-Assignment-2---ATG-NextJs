...
function GetStarted() {
  ...
  return (
    <div className="position-relative row vw-100 d-flex justify-content-center align-items-start" style={{backgroundColor:"#F7FDFF",height:`${mobRes ? "50vh" : "80vh"}`,color:"black"}}>
        ...
        <Image 
                src={people3} 
                alt="Description for people3" 
                className="position-absolute bottom-0" 
                style={{ width: "39%", left: "8%" }} 
                layout="intrinsic"
            />
            <Image 
                src={people4} 
                alt="Description for people4" 
                className="position-absolute bottom-0" 
                style={{ width: "45%", right: "8%" }} 
                layout="intrinsic"
            />
    </div>
  );
